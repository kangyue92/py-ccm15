...
## [2.0.0](https://github.com/kangyue92/py-ccm15/compare/v1.0.0...v2.0.0) (2026-06-30)
...
* accept an injected httpx.AsyncClient and manage its lifecycle ([#40](https://github.com/kangyue92/py-ccm15/issues/40)) ([dc145c2](https://github.com/kangyue92/py-ccm15/commit/dc145c29232d7d5b80d107b2e49583c0b319632b))
* add release-please for automated releases ([#19](https://github.com/kangyue92/py-ccm15/issues/19)) ([7624545](https://github.com/kangyue92/py-ccm15/commit/7624545e23d80ebe58bbe32e09e7ab09f790a874))
* obfuscate password and return CCM15ReturnCode from writes ([#55](https://github.com/kangyue92/py-ccm15/issues/55)) ([64b302b](https://github.com/kangyue92/py-ccm15/commit/64b302b98b323ebf98db10c86b018f1afd312246))
* opt-in electric heater (ht) via a TriState desired value ([#44](https://github.com/kangyue92/py-ccm15/issues/44)) ([2912e1b](https://github.com/kangyue92/py-ccm15/commit/2912e1b067f42001d88ca4de053f520a39df2bae))
* opt-in swing control via a TriState desired value ([#43](https://github.com/kangyue92/py-ccm15/issues/43)) ([c95bf12](https://github.com/kangyue92/py-ccm15/commit/c95bf127bc7fc9ef454fad50e793be8875227d49))
* optional password (pwd=) authentication for control commands ([#17](https://github.com/kangyue92/py-ccm15/issues/17)) ([85a635f](https://github.com/kangyue92/py-ccm15/commit/85a635f3358e3b62b60ac877d91a2812b84dac82))


### Bug Fixes

* handle non-contiguous slots and slaves &gt;= 32 ([#23](https://github.com/kangyue92/py-ccm15/issues/23)) ([d9d7e58](https://github.com/kangyue92/py-ccm15/commit/d9d7e5890d5cf3baf02adc4e28a1e5a3c2fdb80a))
* tolerate transient CCM15 dropouts and report per-device data age ([#34](https://github.com/kangyue92/py-ccm15/issues/34)) ([fe1529c](https://github.com/kangyue92/py-ccm15/commit/fe1529c58964823a084cdeaaf98d6b7607444d7d))
* update async_set_state test to current API ([#21](https://github.com/kangyue92/py-ccm15/issues/21)) ([842bd33](https://github.com/kangyue92/py-ccm15/commit/842bd33bad32b53fafad85a567eb0558ce4947de))
